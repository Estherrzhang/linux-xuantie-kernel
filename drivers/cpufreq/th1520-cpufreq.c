...
static int th1520_cpufreq_probe(struct platform_device *pdev)
{
	...
	np = of_find_compatible_node(NULL, NULL, "thead,th1520-sys-reg");
	if (!np)
		return -ENOENT;
...
static const struct of_device_id th1520_cpufreq_match[] = {
	{ .compatible = "thead,th1520-cpufreq" },
	{},
};

static struct platform_driver th1520_cpufreq_platdrv = {
	.driver = {
		.name	= "thead,th1520-cpufreq",
...
MODULE_DESCRIPTION("Thead TH1520 cpufreq driver");
MODULE_LICENSE("GPL");
